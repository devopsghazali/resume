...
2. Why do branch protections matter in production repos?
3. How do you keep commits readable?
4. When should you squash a PR?
5. How do tags help with deployment traceability?
6. How do you recover from a bad commit safely?
7. What should go in a strong README?
8. How do you use GitHub Issues for project tracking?
