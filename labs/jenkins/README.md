...
Pipeline automation, gates, and controlled release flow.

## Overview

This track keeps 3 practical projects and 10 interview questions around Jenkins.

## Projects

### Project 1: CI Quality Gate Pipeline
...
1. How do you write a Declarative Pipeline?
2. What should be a stage gate in Jenkins?
3. How do you keep credentials safe in Jenkins?
4. How do you trigger pipelines from Git events?
5. Why is a shared library useful?
6. How do you make a pipeline restart-safe?
7. How do you publish Docker images from Jenkins?
8. How do you store build metadata for traceability?
