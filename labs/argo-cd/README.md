...
GitOps delivery, drift control, and progressive sync.

## Overview

This track keeps 3 practical projects and 10 interview questions around Argo CD.

## Projects

### Project 1: App-of-Apps GitOps Controller
...
2. How does Argo CD know the cluster is drifting?
3. What is the app-of-apps pattern?
4. How do sync waves control rollout order?
5. Why is self-heal useful in production?
6. How do you structure an Argo CD repository?
7. When should you disable auto-sync?
8. How do you manage secrets with GitOps safely?
