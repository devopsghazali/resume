...
Fast operational automation for Linux and releases.

## Overview

This track keeps 3 practical projects and 10 interview questions around Shell Scripting.

## Projects

### Project 1: Backup and Rotation Guard
...
1. How do you make a shell script fail fast?
2. Why are quotes important in Bash variables?
3. How do you check exit codes correctly?
4. How do you schedule and audit a cron job?
5. How do you process command output safely with awk or jq?
6. What is the difference between set -e and manual error handling?
7. How do you make a script idempotent?
8. How do you pass arguments cleanly to a script?
